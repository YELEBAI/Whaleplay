...
describe("CreateDialog", () => {
  it("does not render content when open=false", () => {
    render(<CreateDialog open={false} onOpenChange={vi.fn()} onTraditional={vi.fn()} onBuilder={vi.fn()} />);
    expect(screen.queryByText("create.title")).not.toBeInTheDocument();
  });

  it("renders title when open=true", () => {
    render(<CreateDialog open onOpenChange={vi.fn()} onTraditional={vi.fn()} onBuilder={vi.fn()} />);
  ...
  it("calls onTraditional when traditional button clicked", () => {
    ...
    render(<CreateDialog open onOpenChange={vi.fn()} onTraditional={onTraditional} onBuilder={vi.fn()} />);
  ...
  it("calls onBuilder when builder button clicked", () => {
    ...
    render(<CreateDialog open onOpenChange={vi.fn()} onTraditional={vi.fn()} onBuilder={onBuilder} />);
  ...
  it("calls onOpenChange(false) when cancel clicked", () => {
    ...
    render(<CreateDialog open onOpenChange={onOpenChange} onTraditional={vi.fn()} onBuilder={vi.fn()} />);
