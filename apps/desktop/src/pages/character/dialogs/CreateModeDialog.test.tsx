...
describe("CreateModeDialog", () => {
  it("closes dialog when target is null", () => {
    render(
      <CreateModeDialog target={null} creatingMode={null} onSelectMode={vi.fn()} onCancel={vi.fn()} t={t} tc={tc} />,
    );
  ...
  it("renders description with character name", () => {
    ...
    expect(t).toHaveBeenCalledWith("modeDialog.description", { name: "Test" });
  });
